...
export default function Home() {
  return (
    <>
      <header className=" min-h-[90vh] text-black dark:text-[#f6f6f6] pt-10 mx-auto flex max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl items-center justify-start">
        <div className="w-full flex flex-col md:flex-row">
          <div className=" md:w-[50%] flex flex-col justify-center">
            ...
            <p className="font-bold text-sm md:text-md lg:text-lg xl:text-xl 2xl:text-2xl pt-2 text-gray-700">
      ...
      <section className="text-black dark:text-[#f6f6f6] mx-auto flex max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl items-center justify-start">
        <div>
          <div></div>
          <img />
        </div>
